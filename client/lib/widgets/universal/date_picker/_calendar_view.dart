...
class _CalendarViewState extends State<_CalendarView> {
  ...
  void didUpdateWidget(_CalendarView oldWidget) {
    ...
    if (widget.initialMonth != oldWidget.initialMonth &&
      ...
      // );
      CallUtils.onNextFrame(() => _showMonth(widget.initialMonth, jump: true));
    }
  }
  ...
  void handleNextMonth() {
    if (!widget.config.isDisplayingLastMonth(_currentMonth)) {
  ...
  void handlePreviousMonth() {
    if (!widget.config.isDisplayingFirstMonth(_currentMonth)) {
